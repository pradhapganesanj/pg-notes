...
public class KafkaSpoutTopology {
	...
	public static void main(String...str){
		...
		topologyBuilder.setBolt("print-messages", getBolt()).globalGrouping("kafka-spout");
    ...
    public static final String BOOTSTRAP_SERVERS_CONFIG = "localhost:2020";
    public static String groupId; 
    public static final String topicName  = "hello-storm-topic";
