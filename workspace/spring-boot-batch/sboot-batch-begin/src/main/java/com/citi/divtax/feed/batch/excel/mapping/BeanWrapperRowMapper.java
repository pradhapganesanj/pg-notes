package com.citi.divtax.feed.batch.excel.mapping;
...
import com.citi.divtax.feed.batch.excel.rowset.RowSet;
...
public class BeanWrapperRowMapper<T> extends DefaultPropertyEditorRegistrar implements RowMapper<T>, BeanFactoryAware, InitializingBean {
     ...
     * that will be passed into {@link #mapRow(com.citi.divtax.feed.batch.excel.rowset.RowSet)}. Typically a
     ...
     * for every call to {@link #mapRow(com.citi.divtax.feed.batch.excel.rowset.RowSet)}.<br>
     *
